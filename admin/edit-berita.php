...
<body>
  ...
  <div class="wrapper">
    ...
    ?>
       <form method="post" enctype="multipart/form-data">
          ...
          <button class="btn btn-danger"><a  class="text-white" href="berdes.php" style="text-decoration: none; border: none;">kembali</a></button>
  ...
  <?php 
    ...
    $query = "UPDATE berita_desa SET tanggal = '$tanggal', judul = '$judul' , deskripsi = '$deskripsi' WHERE id_berdes = '$id'";
    ...
    if ($result) {
      ...
      echo "<script>
            ...
            window.location.assign('tambah-berdes.php');
            </script>";
      }
    }  else {
        
         move_uploaded_file($_FILES['foto']['tmp_name'], $dir);
          $query = "UPDATE berita_desa SET foto = '$foto', tanggal = '$tanggal', judul = '$judul' , deskripsi = '$deskripsi' WHERE id_berdes = '$id'";
          $result = mysqli_query($koneksi, $query);
