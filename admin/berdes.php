    ...
    <section class="konten">
      <div class="inner">
        <p>
          ...
          <a href="tambah-berdes.php" class="btn btn-primary">Tambah Berita</a>
          <hr>
          ...
          <table class="table table-bordered mt-4">
            ...
            <tbody class="text-center">
              <?php 
                ...
                $no=1;
                $query= mysqli_query($koneksi,"SELECT * FROM berita_desa");
              ...
              <tr>
                ...
                <td><?= $result['judul']; ?></td>
                <td>
                  <a href="edit-berita.php?id=<?= $result['id_berdes']; ?>" class="btn btn-success">edit</a>
                </td>
                <td>
                  <a href="hapus-berdes.php?id=<?= $result['id_berdes']; ?>" class="btn btn-danger">hapus</a>
                </td>
              </tr>
            <?php } ?>
            </tbody>
